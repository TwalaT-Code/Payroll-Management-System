		...
		<div class="row form-group">
			...
			<div class="col-md-3">
				...
				<select id="type" class="borwser-default custom-select">
					<option value="1" required>Time-in AM</option>
					<option value="2" required>Time-out AM</option>
					<option value="3" required>Time-in PM</option>
					<option value="4" required>Tim-out PM</option>
				</select>
			</div>
			<div class="col-md-3">
				<label for="" class="control-label">Date</label>
				<input type="text" id="adate" class="form-control datetimepicker" autocomplete="off" required>
			</div>
			<div class="col-md-2">
